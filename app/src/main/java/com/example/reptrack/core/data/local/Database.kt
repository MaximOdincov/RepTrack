package com.example.reptrack.core.data.local

import androidx.room.Database
import androidx.room.RoomDatabase
import androidx.room.TypeConverters
import com.example.reptrack.core.data.local.convectors.DateTimeConverters
import com.example.reptrack.core.data.local.dao.ExerciseDao
import com.example.reptrack.core.data.local.dao.StatisticDao
import com.example.reptrack.core.data.local.dao.UserDao
import com.example.reptrack.core.data.local.dao.WorkoutDao
import com.example.reptrack.core.data.local.dao.WorkoutTemplateDao
